...
--                 end
--                 if (Selected) then
--                     TeleportPlayer(GetPlayerPed(-1),casinoEntranceVector.x,casinoEntranceVector.y,casinoEntranceVector.z)
...
--                 end
--                 if (Selected) then
--                     TeleportPlayer(GetPlayerPed(-1),casinoExitVector.x,casinoExitVector.y,casinoExitVector.z)
--                 end
--             end)
--         end, function()
--             ---Panels
